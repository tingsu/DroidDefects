package ch.fixme.cowsay.EmmaInstrument;
...
public class InstrumentedActivity extends ch.fixme.cowsay.Main{
public static String TAG = "IntrumentedPlayer";

    private ch.fixme.cowsay.EmmaInstrument.FinishListener mListener;
